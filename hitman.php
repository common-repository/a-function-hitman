...
<code>define('WP_CONTENT_DIR', $wpContentDir);</code><p>";
      ...
      <div class="submit">
        <input class="button-primary" type="submit" name="test_functions" value="Test Functions" />
        &nbsp;
        <input class="button-primary" type="submit" name="kill_functions" value="Kill Functions" />
        &nbsp;
        <input class="button-primary" type="submit" name="save_functions" value="Revive Them" />
      </div>
    </form>
    <br />
    <hr />
